...
WebUI.setText(findTestObject('OR-Authentication/OR-Register/input_first name'), 'indah')

WebUI.setText(findTestObject('OR-Authentication/OR-Register/input_last name'), 'mahlia')

WebUI.setText(findTestObject('OR-Authentication/OR-Register/input_username'), 'indahmah')
